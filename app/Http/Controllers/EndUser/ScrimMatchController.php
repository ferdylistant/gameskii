...
class ScrimMatchController extends Controller
{
    ...
    public function getBracketScrim(Request $request,$idScrim)//for Member User
    {
        try {
            ...
            ->where('scrim_matches.round', '=', '1')
            ->orWhere('scrim_matches.round', '=', '2')
            ->orWhere('scrim_matches.round', '=', '3')
            ->orWhere('scrim_matches.round', '=', '4')
            ->orWhere('scrim_matches.round', '=', '5')
            ->orWhere('scrim_matches.round', '=', '6')
            ->orWhere('scrim_matches.round', '=', '7')
            ->orWhere('scrim_matches.round', '=', '8')
            ->where('team_players.status', '=', '1')
